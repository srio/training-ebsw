...
if __name__ == "__main__":
    ...
    root_file  =  "2PAcut"   # ["BM","3Pcut","2PAcut","2PBcut","1Pcut","3P","2PA","2PB","1P","0P"]
    energy_kev =  5
    emittance = 1            # 0=No, 1=Yes

    focusing = 0    # 0=ideal 1:1   1=Toroid 1:1, 2=Ellipsoid 3:1
